...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.txtInjured, 7, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.txtComment, 9, 0, 1, 2)
        ...
        self.txtYear = QLineEdit(self.layoutWidget)
        self.txtYear.setObjectName(u"txtYear")

        self.gridLayout.addWidget(self.txtYear, 5, 0, 1, 2)
